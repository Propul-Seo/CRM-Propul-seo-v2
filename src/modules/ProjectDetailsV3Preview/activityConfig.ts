...
// Actions visibles dans la QuickActionBar (5 boutons principaux).
...
export const PROJECT_V3_ACTIONS: ActionDef<ActivityType>[] = [
  { type: 'decision', label: 'Décision',   icon: Lightbulb,   colorClass: 'hover:text-violet-400 hover:bg-violet-500/10' },
  { type: 'email',    label: 'E-mail',     icon: Mail,        colorClass: 'hover:text-green-400 hover:bg-green-500/10' },
  { type: 'call',     label: 'Appel',      icon: Phone,       colorClass: 'hover:text-blue-400 hover:bg-blue-500/10' },
  { type: 'task',     label: 'Tâche',      icon: CheckSquare, colorClass: 'hover:text-amber-400 hover:bg-amber-500/10' },
  { type: 'meeting',  label: 'Réunion',    icon: Calendar,    colorClass: 'hover:text-pink-400 hover:bg-pink-500/10' },
]
